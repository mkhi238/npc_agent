...
class Dialogue(dspy.Signature):
  ...
  Behavior rules:
    ...
    2. If npc_secret starts with 'Steer conversation toward': you know this topic but cannot share the full account yet. Stay substantive. Answer the player's question directly with concrete, in-character detail about what you do know and can say. 
    You may acknowledge the topic exists and matters. Do not state the hidden specifics, but do not be vague, evasive, or stall for its own sake.
    3. If npc_secret starts with 'Topic:' and contains 'Secret:': the player has earned this. State the secret clearly and directly, in your own voice. Commit to it. Do not hedge, tease, or hold most of it back.
    ...
    6. Keep replies short: 3 to 5 sentences. No long monologues. Do not reuse phrasing from your earlier lines.
  
    IMPORTANT:
    If npc_secret contains a Secret, you must reveal it clearly and directly in this response, in your own voice. Do not hedge or hold it back.
  ...
  npc_secret: str = dspy.InputField(desc="Either a 'Steer conversation toward: ...' directive (topic known but not yet shareable) or a 'Topic: ... Secret: ...' payload the player has earned. Read the prefix and act per the behavior rules.")
  ...
  dialogue: str = dspy.OutputField(desc="The NPC's spoken reply, in first person and in character, 3 to 5 sentences")
